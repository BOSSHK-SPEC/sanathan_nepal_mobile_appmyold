...
class ThemeProvider with ChangeNotifier {
 ...
 Color? _todaycolor;
  ...
  // The app's screens were designed against Material 2 (Flutter 3.7 defaults).
  // Keep M2 so the SDK upgrade does not change layout/typography; migrate to
  // Material 3 deliberately as a separate design task.
  ThemeData get _darkTheme => ThemeData.dark(useMaterial3: false).copyWith(
  ...
  ThemeData get _lightTheme => ThemeData.light(useMaterial3: false).copyWith(
