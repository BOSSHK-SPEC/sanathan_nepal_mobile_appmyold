...
@override
String toString() {
  return 'GeoLocation(latitude: $latitude, longitude: $longitude, name: $name, nameNe: $nameNe, nameHi: $nameHi)';
}
...
class _GeoLocation extends GeoLocation {
  const _GeoLocation({required this.latitude, required this.longitude, required this.name, this.nameNe, this.nameHi}): super._();
