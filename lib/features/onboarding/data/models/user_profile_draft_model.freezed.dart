...
mixin _$UserProfileDraftModel {
 ...
 String get fullName; String get email; DateTime? get dateOfBirth;@JsonKey(unknownEnumValue: DateSystem.bs) DateSystem get dateSystem; int? get birthTimeMinutes; String get birthPlace;@JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) Gender? get gender;@JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) ZodiacSign? get zodiacSign; String? get avatarUrl;
...
@override
String toString() {
  return 'UserProfileDraftModel(fullName: $fullName, email: $email, dateOfBirth: $dateOfBirth, dateSystem: $dateSystem, birthTimeMinutes: $birthTimeMinutes, birthPlace: $birthPlace, gender: $gender, zodiacSign: $zodiacSign, avatarUrl: $avatarUrl)';
}
...
class _UserProfileDraftModel extends UserProfileDraftModel {
  const _UserProfileDraftModel({this.fullName = '', this.email = '', this.dateOfBirth, @JsonKey(unknownEnumValue: DateSystem.bs) this.dateSystem = DateSystem.bs, this.birthTimeMinutes, this.birthPlace = '', @JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) this.gender, @JsonKey(unknownEnumValue: JsonKey.nullForUndefinedEnumValue) this.zodiacSign, this.avatarUrl}): super._();
