...
mixin _$Product {
 ...
 String get id; String get title; String get titleNe; String get description; String get descriptionNe; double get price; String get categoryId; List<String> get images; Seller get seller; String get location; String get locationNe; DateTime get postedAt; String get currency; ProductCondition get condition; int get views; int get likes; double get rating; bool get isBoosted; bool get isFavourite;/// True when the current user is the seller (used by "My Products").
 bool get isMine;/// The shop this listing belongs to, when the seller has an approved one.
/// A business profile's Products and Services tabs are exactly the
/// listings carrying its id.
 String? get businessId; bool get negotiable;/// True for service listings ("Product vs Service" in the seller form).
 bool get isService; String? get websiteLink; DateTime? get expiresAt;/// Free-form specifications shown in the "General" card
/// (e.g. `{'Carat': '7', 'Origin': 'Sri Lanka'}`).
 Map<String, String> get specs;/// Selectable options (e.g. `{'Select Metal': ['Silver', 'Gold']}`).
 Map<String, List<String>> get options; List<ProductComment> get comments;/// Seller video links shown in the "Product Videos" card.
...
@useResult
$Res call({
 String id, String title, String titleNe, String description, String descriptionNe, double price, String categoryId, List<String> images, Seller seller, String location, String locationNe, DateTime postedAt, String currency, ProductCondition condition, int views, int likes, double rating, bool isBoosted, bool isFavourite, bool isMine, String? businessId, bool negotiable, bool isService, String? websiteLink, DateTime? expiresAt, Map<String, String> specs, Map<String, List<String>> options, List<ProductComment> comments, List<String> videos
});
...
as Seller,location: null == location ? _self.location : location // ignore: cast_nullable_to_non_nullable
...
as List<ProductComment>,videos: null == videos ? _self.videos : videos // ignore: cast_nullable_to_non_nullable
as List<String>,
  ));
}
/// Create a copy of Product
...
class _Product extends Product {
  const _Product({required this.id, required this.title, required this.titleNe, required this.description, required this.descriptionNe, required this.price, required this.categoryId, required final  List<String> images, required this.seller, required this.location, required this.locationNe, required this.postedAt, this.currency = 'NPR', this.condition = ProductCondition.used, this.views = 0, this.likes = 0, this.rating = 0, this.isBoosted = false, this.isFavourite = false, this.isMine = false, this.businessId, this.negotiable = false, this.isService = false, this.websiteLink, this.expiresAt, final  Map<String, String> specs = const {}, final  Map<String, List<String>> options = const {}, final  List<ProductComment> comments = const [], final  List<String> videos = const []}): _images = images,_specs = specs,_options = options,_comments = comments,_videos = videos,super._();
...
@override@JsonKey() Map<String, List<String>> get options {
 ...
 final  List<ProductComment> _comments;
@override@JsonKey() List<ProductComment> get comments {
...
as List<ProductComment>,videos: null == videos ? _self._videos : videos // ignore: cast_nullable_to_non_nullable
as List<String>,
  ));
}
